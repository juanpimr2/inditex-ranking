package io.github.juanpimr2.inditex_ranking.infrastructure.web;
...
public class ProductController {
    ...
    private final RankingInputPort rankingInputPort;
    ...
    @Operation(
        ...
        - `weightsTO.salesUnits` y `weightsTO.stockRatio` están en rango [0..1] y no necesitan sumar 1.
                    ...
                    content = @Content(
                            ...
                            examples = {
                                    @ExampleObject(
                                            ...
                                            value = """
                        { "weightsTO": { "salesUnits": 0.7, "stockRatio": 0.3 } }
                        """
                                    ),
                                    @ExampleObject(
                                            ...
                                            value = """
                        {
                          "weightsTO": { "salesUnits": 1.0, "stockRatio": 0.0 },
                          "products": [
    ...
    public ResponseEntity<RankResponse> rank(@Valid @RequestBody RankRequest req) {
        RankResponse ranked = rankingInputPort.rank(req);
